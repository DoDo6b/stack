...
static void reallocTest ()
{
    log_string ("<blu><b>Realloc work test</b><dft>\n");

    StackHandler stack = stackInit (1, sizeof (int));
    ...
    for (size_t i = 0; i < 23; i++)
    {
        ...
        assertStrict (stackVerify (stack) == 0, "<red>TEST FAILED<dft>");
    }
